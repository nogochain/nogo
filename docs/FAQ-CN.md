...
| 年份 | 年发行量 | 流通量 | 通胀率 |
|------|---------|--------|--------|
| 1 | 8,410,000 | 8,410,000 | 100% |
| 5 | 5,520,000 | 34,440,000 | 16.02% |
| 10 | 3,260,000 | 54,780,000 | 5.95% |
| 20 | 1,140,000 | 73,870,000 | 1.54% |
| 30 | 400,000 | 80,530,000 | 0.50% |

### Q22: 手续费如何分配？

**A**: 100% 销毁（不归矿工），激励矿工打包交易的是区块奖励。
...
- **Issue 追踪**: https://github.com/nogochain/nogo/issues
...
### v1.1.0 (2026-05-29)
- 🐛 修复中文编码问题（UTF-8 乱码）
- 📝 更新 API 端点路径（/tx/submit → /tx, /account/balance → /balance）
- 🔧 更新环境变量名称以匹配代码实现
- ✅ 验证所有示例命令与实际代码一致
