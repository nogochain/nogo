...
**代码实现参考**: 
- HTTP API 路由：[`blockchain/api/http.go`](../blockchain/api/http.go)
- WebSocket 服务器：[`blockchain/api/ws.go`](../blockchain/api/ws.go)
- 错误码：[`blockchain/api/error_codes.go`](../blockchain/api/error_codes.go)
- 速率限制器：[`blockchain/api/rate_limiter.go`](../blockchain/api/rate_limiter.go)
...
**代码参考**: [`handleVersion`](../blockchain/api/http.go#L1846-L1858)
...
**错误码参考**: 完整错误码列表见 [错误码参考](./API/错误码参考_cn.md)。
